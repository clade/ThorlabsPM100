...
class SenseEnergyReference(Group):
    ...
    class value(GenericGetSetCommandClass):
        ...
        value=Argument(0,["MINimum","MAXimum","DEFault","<numeric_value>J"])
...
class SensePowerDcReference(Group):
    ...
    class value(GenericGetSetCommandClass):
        ...
        value=Argument(0,["MINimum","MAXimum","DEFault","<numeric_value>W"])
...
class SenseCurrentDcReference(Group):
    ...
    class value(GenericGetSetCommandClass):
        ...
        value=Argument(0,["MINimum","MAXimum","DEFault","<numeric_value>A"])
...
class SenseVoltageDc(Group):
    ...
    class reference(GenericGetSetCommandClass):
        ...
        value=Argument(0,["MINimum","MAXimum","DEFault","<numeric_value>V"])
...
class SenseCorrectionLossInput(Group):
    ...
    class magnitude(GenericGetSetCommandClass):
        ...
        value=Argument(0,["MINimum","MAXimum","DEFault","<numeric_value>"])
...
class SenseCorrection(Group):
    ...
    class beamdiameter(GenericGetSetCommandClass):
        ...
        value=Argument(0,["MINimum","MAXimum","DEFault","<numeric_value>mm"])
...
class InputThermopileAccelerator(Group):
    ...
    class tau(GenericGetSetCommandClass):
        ...
        value=Argument(0,["MINimum","MAXimum","DEFault","<numeric_value>s"])
